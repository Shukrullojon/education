                            ...
                            <div class="card-header border-0">
                                ...
                                <div class="card-toolbar">
                                    <button type="button"
                                            ...
                                            data-bs-toggle="modal" data-bs-target="#kt_modal_create_room">
                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            <div class="card-header border-0">
                                ...
                                <div class="card-toolbar">
                                    <button type="button"
                                            class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary"
                                            data-bs-toggle="modal" data-bs-target="#kt_modal_create_student">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen024.svg-->
                                        <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Code\Plus.svg--><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('begin_time', null, array('placeholder' => 'Begin Time','class' => 'form-control')) !!}
                            </div>
