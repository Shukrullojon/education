        ...
        <div class="row">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('event_id', $events, $student->event->event_id ?? 0, ['placeholder' => '','class' => 'form-control']) !!}
                </div>
            </div>
            ...
            <div class="col-xs-3 col-sm-3 col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('status', \App\Helpers\StatusHelper::$studentStatus,null, ['placeholder' => '','class' => 'form-control']) !!}
                </div>
            </div>
