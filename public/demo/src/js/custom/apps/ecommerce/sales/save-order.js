    ...
    const handleProductSelect = () => {
        ...
        checkboxes.forEach(checkbox => {
            checkbox.addEventListener('change', e => {
                ...
                const product = parent.querySelector('[data-kt-ecommerce-edit-order-filter="products"]').cloneNode(true);
                ...
                if (e.target.checked) {
                    // Add products to selected products wrapper
                    target.appendChild(product);
                } else {
                    // Remove products from selected products wrapper
        ...
        const detectEmpty = () => {
            ...
            const products = target.querySelectorAll('[data-kt-ecommerce-edit-order-filter="products"]');
